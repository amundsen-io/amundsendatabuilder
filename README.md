...
to `WhateverNameOfYourSchema`. Note that https://docs.snowflake.com/en/sql-reference/account-usage.html#differences-between-account-usage-and-information-schema `ACCOUNT_USAGE` is a separate schema

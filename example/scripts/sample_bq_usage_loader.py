...
def create_bq_job(metadata_type, gcloud_project):
    ...
    task = DefaultTask(extractor=bq_usage_extractor, loader=csv_loader, transformer=BigqueryUsageTransformer())

    job_config = ConfigFactory.from_dict(
        {
            "extractor.bigquery_table_usage.{}".format(BigQueryTableUsageExtractor.PROJECT_ID_KEY): gcloud_project,

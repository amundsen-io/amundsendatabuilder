...
class DashboardQuery(GraphSerializable):
    ...
    DASHBOARD_QUERY_KEY_FORMAT = (
        "{product}_dashboard://{cluster}.{dashboard_group_id}/" "{dashboard_id}/query/{query_id}"
    )
    ...
    def _create_node_iterator(self) -> Iterator[GraphNode]:
        ...
        node = GraphNode(
            key=self._get_query_node_key(), label=DashboardQuery.DASHBOARD_QUERY_LABEL, attributes=node_attributes
        )

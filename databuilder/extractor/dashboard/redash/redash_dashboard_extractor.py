...
class TableRelationData:
    ...
    def __init__(self, database: str, cluster: str, schema: str, name: str) -> None:
...
class RedashDashboardExtractor(Extractor):
    ...
    def init(self, conf: ConfigTree) -> None:
        ...
        self._cluster = conf.get_string(RedashDashboardExtractor.CLUSTER_KEY, RedashDashboardExtractor.DEFAULT_CLUSTER)
    ...
    def _get_extract_iter(self) -> Iterator[Any]:
        ...
        while True:
            ...
            dash_data = {
                ...
                "dashboard_url": "{redash}/dashboard/{slug}".format(redash=self._redash_base_url, slug=record["slug"]),
    ...
    def _build_extractor(self) -> RestAPIExtractor:
        ...
        rest_api_extractor_conf = ConfigFactory.from_dict({REST_API_QUERY: self._build_restapi_query()})

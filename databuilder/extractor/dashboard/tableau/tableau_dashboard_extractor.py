...
class TableauGraphQLApiMetadataExtractor(TableauGraphQLApiExtractor):
    ...
    def execute(self) -> Iterator[Dict[str, Any]]:
        ...
        workbooks_data = [
            ...
            if workbook["projectName"] not in self._conf.get_list(TableauGraphQLApiMetadataExtractor.EXCLUDED_PROJECTS)
        ]
        ...
        for workbook in workbooks_data:
            data = {
                ...
                "dashboard_url": "{}/#/workbooks/{}/views".format(
                    self._conf.get(TableauGraphQLApiMetadataExtractor.TABLEAU_BASE_URL), workbook["vizportalUrlId"]
                ),

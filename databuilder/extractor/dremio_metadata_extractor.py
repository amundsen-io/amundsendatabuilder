...
class DremioMetadataExtractor(Extractor):
    ...
    def init(self, conf: ConfigTree) -> None:
        ...
        if exclude_sys_tables and exclude_pds_tables:
            where_stmt = "WHERE nested_0.TABLE_TYPE != 'SYSTEM_TABLE' AND " "nested_0.TABLE_TYPE != 'TABLE';"
        ...
        self.sql_stmt = DremioMetadataExtractor.SQL_STATEMENT.format(cluster=self._cluster, where_stmt=where_stmt)

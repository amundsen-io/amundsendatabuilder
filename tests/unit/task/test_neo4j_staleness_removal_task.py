            ...
            job_config = ConfigFactory.from_dict(
                {
                    ...
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.NEO4J_END_POINT_KEY): "foobar",
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.NEO4J_USER): "foo",
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.NEO4J_PASSWORD): "bar",
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.STALENESS_MAX_PCT): 90,
            ...
            job_config = ConfigFactory.from_dict(
                {
                    ...
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.NEO4J_USER): "foo",
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.NEO4J_PASSWORD): "bar",
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.STALENESS_MAX_PCT): 5,
                    neo4j_csv_publisher.JOB_PUBLISH_TAG: "foo",
                }
            )
            ...
            job_config = ConfigFactory.from_dict(
                {
                    ...
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.NEO4J_PASSWORD): "bar",
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.STALENESS_MAX_PCT): 5,
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.STALENESS_PCT_MAX_DICT): {"foo": 51},
                    neo4j_csv_publisher.JOB_PUBLISH_TAG: "foo",
                }
            )

            task.init(job_config)
            total_records = [{"type": "foo", "count": 100}, {"type": "bar", "count": 100}]
            stale_records = [{"type": "foo", "count": 50}, {"type": "bar", "count": 3}]
            targets = {"foo", "bar"}
            task._validate_staleness_pct(total_records=total_records, stale_records=stale_records, types=targets)
            ...
            job_config = ConfigFactory.from_dict(
                {
                    ...
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.NEO4J_PASSWORD): "bar",
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.STALENESS_MAX_PCT): 5,
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.MS_TO_EXPIRE): 86400000,
                }
            )
            ...
            job_config = ConfigFactory.from_dict(
                {
                    ...
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.NEO4J_PASSWORD): "bar",
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.STALENESS_MAX_PCT): 5,
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.TARGET_NODES): ["Foo"],
                    neo4j_csv_publisher.JOB_PUBLISH_TAG: "foo",
                }
            )
            ...
            job_config = ConfigFactory.from_dict(
                {
                    ...
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.NEO4J_PASSWORD): "bar",
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.STALENESS_MAX_PCT): 5,
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.MS_TO_EXPIRE): 9876543210,
                }
            )
            ...
            job_config = ConfigFactory.from_dict(
                {
                    ...
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.STALENESS_MAX_PCT): 5,
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.TARGET_NODES): ["Foo"],
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.TARGET_RELATIONS): ["BAR"],
                    neo4j_csv_publisher.JOB_PUBLISH_TAG: "foo",
                }
            )
            ...
            job_config = ConfigFactory.from_dict(
                {
                    ...
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.TARGET_NODES): ["Foo"],
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.TARGET_RELATIONS): ["BAR"],
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.MS_TO_EXPIRE): 24 * 60 * 60 * 100
                    - 10,
                }
            )
            ...
            job_config = ConfigFactory.from_dict(
                {
                    ...
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.TARGET_NODES): ["Foo"],
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.TARGET_RELATIONS): ["BAR"],
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.MS_TO_EXPIRE): 24 * 60 * 60 * 1000,
                }
            )
            task.init(job_config)
            ...
            job_config = ConfigFactory.from_dict(
                {
                    ...
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.TARGET_NODES): ["Foo"],
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.TARGET_RELATIONS): ["BAR"],
                    "{}.{}".format(task.get_scope(), neo4j_staleness_removal_task.DRY_RUN): True,
                    neo4j_csv_publisher.JOB_PUBLISH_TAG: "foo",
                }
            )

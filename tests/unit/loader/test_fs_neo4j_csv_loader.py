...
class TestFsNeo4jCSVLoader(unittest.TestCase):
        ...
        self._conf = ConfigFactory.from_dict(
            {
                ...
                FsNeo4jCSVLoader.RELATION_DIR_PATH: "{}/{}".format(prefix, "relationships"),
    ...
    def test_load(self) -> None:
        ...
        expected_node_path = "{}/../resources/fs_neo4j_csv_loader/nodes".format(os.path.join(os.path.dirname(__file__)))
        expected_nodes = self._get_csv_rows(expected_node_path, itemgetter("KEY"))
        actual_nodes = self._get_csv_rows(self._conf.get_string(FsNeo4jCSVLoader.NODE_DIR_PATH), itemgetter("KEY"))
        self.assertEqual(expected_nodes, actual_nodes)

        expected_rel_path = "{}/../resources/fs_neo4j_csv_loader/relationships".format(
        ...
        actual_relations = self._get_csv_rows(
            self._conf.get_string(FsNeo4jCSVLoader.RELATION_DIR_PATH), itemgetter("START_KEY", "END_KEY")
        )

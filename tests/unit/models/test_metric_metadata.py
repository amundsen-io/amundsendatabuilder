...
class TestMetricMetadata(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.metric_metadata = MetricMetadata(
            "Product - Jobs.cz",
            "Agent",
            "Metric 1",
            "a/b*(2*x)",
        ...
        self.metric_metadata2 = MetricMetadata(
            "Product - Jobs.cz",
            "Agent",
            "Metric 2",
            "b/a*(2*x)",
        ...
        self.metric_metadata3 = MetricMetadata("Product - Atmoskop", "Atmoskop", "Metric 3", "x*x*x", "", "", [])

        self.expected_nodes_deduped = [
            {"name": "Metric 1", "KEY": "metric://Metric 1", "LABEL": "Metric", "expression": "a/b*(2*x)"},
            {
                "description": "This is description of Metric 1",
                "KEY": "metric://Metric 1/_description",
                "LABEL": "Description",
            },
        ...
        self.expected_rels_deduped = [
            {
                "END_KEY": "Product - Jobs.cz://Agent",
                "START_LABEL": "Metric",
                "END_LABEL": "Dashboard",
                "START_KEY": "metric://Metric 1",
                "TYPE": "METRIC_OF",
                "REVERSE_TYPE": "METRIC",
            },
            {
                "END_KEY": "metric://Metric 1/_description",
                "START_LABEL": "Metric",
            ...
            {
                "END_KEY": "type://MasterMetric",
                "START_LABEL": "Metric",
                "END_LABEL": "Metrictype",
                "START_KEY": "metric://Metric 1",
                "TYPE": "METRIC_TYPE",
                "REVERSE_TYPE": "METRIC_TYPE_OF",
            },
        ]
        ...
        self.expected_nodes_deduped2 = [
            ...
            {
                "description": "M2 This is description of Metric 2",
                "KEY": "metric://Metric 2/_description",
                "LABEL": "Description",
            },
            {"tag_type": "metric", "KEY": "Dummy Metric TAG", "LABEL": "Tag"},
            {"name": "MasterMetric", "KEY": "type://MasterMetric", "LABEL": "Metrictype"},
        ...
        self.expected_rels_deduped2 = [
            {
                ...
                "START_LABEL": "Metric",
                "END_LABEL": "Dashboard",
                "START_KEY": "metric://Metric 2",
                "TYPE": "METRIC_OF",
                "REVERSE_TYPE": "METRIC",
            },
            {
                "END_KEY": "metric://Metric 2/_description",
                "START_LABEL": "Metric",
                "END_LABEL": "Description",
                "START_KEY": "metric://Metric 2",
                "TYPE": "DESCRIPTION",
        ...
        self.expected_rels_deduped3 = [
            {
                "END_KEY": "Product - Atmoskop://Atmoskop",
                "START_LABEL": "Metric",
                "END_LABEL": "Dashboard",
                "START_KEY": "metric://Metric 3",
                "TYPE": "METRIC_OF",
                "REVERSE_TYPE": "METRIC",
            }
        ]

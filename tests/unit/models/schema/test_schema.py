...
class TestSchemaDescription(unittest.TestCase):
    def test_create_nodes(self) -> None:
        ...
        schema = SchemaModel(schema_key="db://cluster.schema", schema="schema_name", description="foo")
        ...
        self.assertDictEqual(
            serialized_schema_node, {"name": "schema_name", "KEY": "db://cluster.schema", "LABEL": "Schema"}
        )
        self.assertDictEqual(
            serialized_schema_desc_node,
            {
                ...
                "description": "foo",
                "KEY": "db://cluster.schema/_description",
                "LABEL": "Description",
            },
        )
    ...
    def test_create_nodes_no_description(self) -> None:
        ...
        schema = SchemaModel(schema_key="db://cluster.schema", schema="schema_name")
    ...
    def test_create_nodes_programmatic_description(self) -> None:
        ...
        schema = SchemaModel(
            schema_key="db://cluster.schema", schema="schema_name", description="foo", description_source="bar"
        )
        ...
        self.assertDictEqual(
            serialized_schema_prod_desc_node,
            {
                "description_source": "bar",
                "description": "foo",
                "KEY": "db://cluster.schema/_bar_description",
    ...
    def test_create_relation(self) -> None:
        ...
        expected = {
            "END_KEY": "db://cluster.schema/_description",
            "START_LABEL": "Schema",
            "END_LABEL": "Description",
            "START_KEY": "db://cluster.schema",
            "TYPE": "DESCRIPTION",
    ...
    def test_create_relation_programmatic_description(self) -> None:
        ...
        serialized_actual = neo4_serializer.serialize_relationship(actual)
        expected = {
            "END_KEY": "db://cluster.schema/_bar_description",
            "START_LABEL": "Schema",

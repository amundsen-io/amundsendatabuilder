...
class TestDashboardMetadata(unittest.TestCase):
    def setUp(self) -> None:
        # Full exammple
        self.dashboard_metadata = DashboardMetadata(
            "Product - Jobs.cz",
            "Agent",
        ...
        # Without tags
        self.dashboard_metadata2 = DashboardMetadata(
            "Product - Atmoskop",
            "Atmoskop",
        ...
        self.dashboard_metadata3 = DashboardMetadata("Product - Jobs.cz", "Dohazovac", "", ["test_tag", "tag3"])

        # Necessary minimum -- NOT USED
        self.dashboard_metadata4 = DashboardMetadata("", "PzR", "", [])
        ...
        self.expected_nodes_deduped = [
            ...
            },
            {
                ...
                "KEY": "_dashboard://gold.Product - Jobs.cz",
                "LABEL": "Dashboardgroup",
                "dashboard_group_url": "https://foo.bar/dashboard_group/foo",
            },
            {
                "KEY": "_dashboard://gold.Product - Jobs.cz/_description",
                "LABEL": "Description",
                "description": "foo dashboard group description",
            },
            {
                "description": "Agent dashboard description",
                "KEY": "_dashboard://gold.Product - Jobs.cz/Agent/_description",
                "LABEL": "Description",
            },
        ...
        self.expected_rels_deduped = [
            {
                "END_KEY": "_dashboard://gold.Product - Jobs.cz",
                "END_LABEL": "Dashboardgroup",
                "REVERSE_TYPE": "DASHBOARD_GROUP_OF",
                "START_KEY": "_dashboard://gold",
                "START_LABEL": "Cluster",
                "TYPE": "DASHBOARD_GROUP",
            },
            {
                "END_KEY": "_dashboard://gold.Product - Jobs.cz/_description",
                "END_LABEL": "Description",
                "REVERSE_TYPE": "DESCRIPTION_OF",
                "START_KEY": "_dashboard://gold.Product - Jobs.cz",
                "START_LABEL": "Dashboardgroup",
                "TYPE": "DESCRIPTION",
            },
            {
                "END_KEY": "_dashboard://gold.Product - Jobs.cz",
                ...
                "END_LABEL": "Dashboardgroup",
                "START_KEY": "_dashboard://gold.Product - Jobs.cz/Agent",
                "TYPE": "DASHBOARD_OF",
                "REVERSE_TYPE": "DASHBOARD",
            },
            {
                "END_KEY": "_dashboard://gold.Product - Jobs.cz/Agent/_description",
                "START_LABEL": "Dashboard",
                "END_LABEL": "Description",
                "START_KEY": "_dashboard://gold.Product - Jobs.cz/Agent",
                "TYPE": "DESCRIPTION",
        ...
        self.expected_rels_deduped2 = [
            {
                "END_KEY": "_dashboard://gold.Product - Atmoskop",
                "END_LABEL": "Dashboardgroup",
                "REVERSE_TYPE": "DASHBOARD_GROUP_OF",
                "START_KEY": "_dashboard://gold",
                "START_LABEL": "Cluster",
            ...
            },
            {
                ...
                "START_LABEL": "Dashboard",
                "END_LABEL": "Dashboardgroup",
                "START_KEY": "_dashboard://gold.Product - Atmoskop/Atmoskop",
                "TYPE": "DASHBOARD_OF",
                "REVERSE_TYPE": "DASHBOARD",
            },
            {
                "END_KEY": "_dashboard://gold.Product - Atmoskop/Atmoskop/_description",
                "START_LABEL": "Dashboard",
                "END_LABEL": "Description",
                "START_KEY": "_dashboard://gold.Product - Atmoskop/Atmoskop",
                "TYPE": "DESCRIPTION",
        ...
        self.expected_rels_deduped3 = [
            ...
            },
            {
                ...
                "START_LABEL": "Dashboard",
                "END_LABEL": "Dashboardgroup",
                "START_KEY": "_dashboard://gold.Product - Jobs.cz/Dohazovac",
                "TYPE": "DASHBOARD_OF",
                "REVERSE_TYPE": "DASHBOARD",
            },
            {

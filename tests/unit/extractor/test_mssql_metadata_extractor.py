...
class TestMSSQLMetadataExtractor(unittest.TestCase):
    def setUp(self) -> None:
        ...
        config_dict = {
            ...
            "extractor.mssql_metadata.{}".format(MSSQLMetadataExtractor.CLUSTER_KEY): "MY_CLUSTER",
            "extractor.mssql_metadata.{}".format(MSSQLMetadataExtractor.USE_CATALOG_AS_CLUSTER_NAME): False,
            "extractor.mssql_metadata.{}".format(MSSQLMetadataExtractor.DATABASE_KEY): "mssql",
    ...
    def test_extraction_with_single_result(self) -> None:
        with patch.object(SQLAlchemyExtractor, "_get_connection") as mock_connection:
            ...
            table = {
                ...
                "cluster": self.conf["extractor.mssql_metadata.{}".format(MSSQLMetadataExtractor.CLUSTER_KEY)],
            }

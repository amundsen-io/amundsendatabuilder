...
class TestSqlAlchemyExtractor(unittest.TestCase):
    ...
    def test_extraction_with_empty_query_result(self: Any, mock_method: Any) -> None:
        """
    ...
    @patch.object(SQLAlchemyExtractor, "_get_connection")
    def test_extraction_with_single_query_result(self: Any, mock_method: Any) -> None:
        """
    ...
    @patch.object(SQLAlchemyExtractor, "_get_connection")
    def test_extraction_with_multiple_query_result(self: Any, mock_method: Any) -> None:
        """
        ...
        self.assertEqual(result, ["test_result", "test_result2", "test_result3"])
    ...
    def test_extraction_with_model_class(self: Any, mock_method: Any) -> None:
        ...
        config_dict = {
            "extractor.sqlalchemy.conn_string": "TEST_CONNECTION",
            "extractor.sqlalchemy.extract_sql": "SELECT 1 FROM TEST_TABLE;",
            "extractor.sqlalchemy.model_class": "tests.unit.extractor.test_sql_alchemy_extractor.TableMetadataResult",
        }
        self.conf = ConfigFactory.from_dict(config_dict)

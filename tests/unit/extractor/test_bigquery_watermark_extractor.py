...
PARTITION_DATA = {
    ...
    "totalRows": "3",
    "rows": [
        {"f": [{"v": "20180802"}, {"v": "1.547512241348E9"}]},
...
class MockBigQueryClient:
    def __init__(self, dataset_list_data: Any, table_list_data: Any, partition_data: Any) -> None:
...
class TestBigQueryWatermarkExtractor(unittest.TestCase):
    def setUp(self) -> None:
        config_dict = {
            "extractor.bigquery_watermarks.{}".format(BigQueryWatermarkExtractor.PROJECT_ID_KEY): "your-project-here"
        }
    ...
    def test_keypath_can_be_set(self, mock_build: Any) -> None:
        config_dict = {
            "extractor.bigquery_watermarks.{}".format(BigQueryWatermarkExtractor.PROJECT_ID_KEY): "your-project-here",
            "extractor.bigquery_watermarks.{}".format(BigQueryWatermarkExtractor.KEY_PATH_KEY): "/tmp/doesnotexist",
        }

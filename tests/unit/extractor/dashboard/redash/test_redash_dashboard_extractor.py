...
class TestRedashDashboardExtractor(unittest.TestCase):
    ...
    def test_with_one_dashboard(self) -> None:
        ...
        config = ConfigFactory.from_dict(
            {
                ...
                "extractor.redash_dashboard.table_parser": "tests.unit.extractor.dashboard.redash.test_redash_dashboard_extractor.dummy_tables",
            }
        )
        ...
        with patch("databuilder.rest_api.rest_api_query.requests.get") as mock_get:
            ...
            expected_timestamp = DashboardLastModifiedTimestamp(last_modified_timestamp=1577923200, **identity)
            ...
            expected_table = DashboardTable(
                table_ids=[TableRelationData("some_db", "prod", "public", "users").key], **identity
            )

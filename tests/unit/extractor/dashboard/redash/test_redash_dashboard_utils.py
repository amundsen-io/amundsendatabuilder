...
class TestRedashDashboardUtils(unittest.TestCase):
    def test_sort_widgets(self) -> None:
        widgets = [
            {"text": "a", "options": {}},
            {"text": "b", "options": {"position": {"row": 1, "col": 1}}},
            {"text": "c", "options": {"position": {"row": 1, "col": 2}}},
            {"text": "d", "options": {"position": {"row": 2, "col": 1}}},
        ]
    ...
    def test_visualization_widget_props(self) -> None:
        widget_data = {
            "visualization": {
                "query": {"id": 123, "data_source_id": 1, "query": "SELECT 2+2 FROM DUAL", "name": "Test"}
            }
        }
    ...
    def test_descriptions_from_text(self) -> None:
        text_widgets = get_text_widgets([{"text": "T1"}, {"text": "T2"}])
        viz_widgets = get_visualization_widgets(
            [
                {"visualization": {"query": {"id": 1, "data_source_id": 1, "name": "Q1", "query": "n/a"}}},
                {"visualization": {"query": {"id": 2, "data_source_id": 1, "name": "Q2", "query": "n/a"}}},
            ]
        )
    ...
    def test_paginated_rest_api_query(self) -> None:
        paged_content = [
            {"page": 1, "page_size": 5, "count": 12, "results": [{"test": True}] * 5},
            {"page": 2, "page_size": 5, "count": 12, "results": [{"test": True}] * 5},
            {"page": 3, "page_size": 5, "count": 12, "results": [{"test": True}] * 2},
            {"page": 4, "page_size": 5, "count": 12, "results": []},
        ]

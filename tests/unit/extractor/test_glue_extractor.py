            ...
            mock_search.return_value = [
                {
                    ...
                    "StorageDescriptor": {
                        "Columns": [
                            {"Name": "col_id1", "Type": "bigint", "Comment": "description of id1"},
                            {"Name": "col_id2", "Type": "bigint", "Comment": "description of id2"},
                            {"Name": "is_active", "Type": "boolean"},
                            {"Name": "source", "Type": "varchar", "Comment": "description of source"},
                            {"Name": "etl_created_at", "Type": "timestamp", "Comment": "description of etl_created_at"},
                            {"Name": "ds", "Type": "varchar"},
                        ]
                    },
                    "PartitionKeys": [
                        {"Name": "partition_key1", "Type": "string", "Comment": "description of partition_key1"},
                    ],
            ...
            mock_search.return_value = [
                {
                    ...
                    "StorageDescriptor": {
                        "Columns": [
                            {"Name": "col_id1", "Type": "bigint", "Comment": "description of col_id1"},
                            {"Name": "col_id2", "Type": "bigint", "Comment": "description of col_id2"},
                            {"Name": "is_active", "Type": "boolean"},
                            {"Name": "source", "Type": "varchar", "Comment": "description of source"},
                            {"Name": "etl_created_at", "Type": "timestamp", "Comment": "description of etl_created_at"},
                            {"Name": "ds", "Type": "varchar"},
                ...
                },
                {
                    ...
                    "StorageDescriptor": {
                        "Columns": [
                            {"Name": "col_name", "Type": "varchar", "Comment": "description of col_name"},
                            {"Name": "col_name2", "Type": "varchar", "Comment": "description of col_name2"},
                        ]
                    },
                    "TableType": "EXTERNAL_TABLE",
                },
                {
                    ...
                    "StorageDescriptor": {
                        "Columns": [
                            {"Name": "col_id3", "Type": "varchar", "Comment": "description of col_id3"},
                            {"Name": "col_name3", "Type": "varchar", "Comment": "description of col_name3"},
                        ]
                    },

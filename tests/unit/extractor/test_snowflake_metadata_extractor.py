...
class TestSnowflakeMetadataExtractor(unittest.TestCase):
    def setUp(self) -> None:
        ...
        config_dict = {
            ...
            "extractor.snowflake_metadata.{}".format(SnowflakeMetadataExtractor.CLUSTER_KEY): "MY_CLUSTER",
            "extractor.snowflake_metadata.{}".format(SnowflakeMetadataExtractor.USE_CATALOG_AS_CLUSTER_NAME): False,
            "extractor.snowflake_metadata.{}".format(SnowflakeMetadataExtractor.SNOWFLAKE_DATABASE_KEY): "prod",
        }
    ...
    def test_extraction_with_single_result(self) -> None:
        with patch.object(SQLAlchemyExtractor, "_get_connection") as mock_connection:
            ...
            table = {
                ...
                "cluster": self.conf["extractor.snowflake_metadata.{}".format(SnowflakeMetadataExtractor.CLUSTER_KEY)],
                "is_view": "false",
            }
            ...
            sql_execute.return_value = [
                ...
                self._union(
                    {"col_name": "is_active", "col_type": "boolean", "col_description": None, "col_sort_order": 2},
                    table,
                ),
                self._union(
                    {
                ...
                self._union(
                    {"col_name": "ds", "col_type": "varchar", "col_description": None, "col_sort_order": 5}, table
                ),
            ]

...
class TestAthenaMetadataExtractor(unittest.TestCase):
    def setUp(self) -> None:
        ...
        config_dict = {
            ...
            "extractor.athena_metadata.{}".format(AthenaMetadataExtractor.CATALOG_KEY): "MY_CATALOG",
        }
    ...
    def test_extraction_with_single_result(self) -> None:
        with patch.object(SQLAlchemyExtractor, "_get_connection") as mock_connection:
            ...
            expected = TableMetadata(
                "athena",
                self.conf["extractor.athena_metadata.{}".format(AthenaMetadataExtractor.CATALOG_KEY)],
                "test_schema",
                "test_table",
                "",
                [
